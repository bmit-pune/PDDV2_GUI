...

{
  ...
  /*  if ((e->key() == Qt::Key_R) && (e->isAutoRepeat() == false)) { //change range of FFT
    ...
    if ((e->key() == Qt::Key_T) && (e->isAutoRepeat() == false)) //STORE FILE
    {
    ...
    if ((e->key() == Qt::Key_R) && (e->isAutoRepeat() == false)){ //Data retv
    ...
    if ((e->key() == Qt::Key_G) && (e->isAutoRepeat() == false)){ //GPS
    if(GPS_FLAG==0){
    ...
    if ((e->key() == Qt::Key_E) && (e->isAutoRepeat() == false)) {
        if (SLEEP_FLAG == 0) {
    ...
    if ((e->key() == Qt::Key_W) && (e->isAutoRepeat() == true)){ //Shutdown
    exec("echo 0 > /sys/class/backlight/backlight.34/brightness");
    exec("poweroff");
    }
}
