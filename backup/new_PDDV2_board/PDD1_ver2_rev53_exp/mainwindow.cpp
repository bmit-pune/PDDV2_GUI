...
QPixmap tick("/opt/new/yellow_tick.jpg");
    ...
    for(int i=0;i<5;i++){
        ...
        switch((*(recv_index+i))){
        case 0:gradient_position=0.2;break;
        case 1:gradient_position=0.4;break;
        case 2:gradient_position=0.6;break;
        case 3:gradient_position=0.8;break;
        case 4:gradient_position=1.0;break;
        }
