...
#ifdef PCGUI
QPixmap dice1("/home/nishad/pdd_workspace/oct-16/build/new/1.jpg");
QPixmap dice2("/home/nishad/pdd_workspace/oct-16/build/new/2.jpg");
QPixmap dice3("/home/nishad/pdd_workspace/oct-16/build/new/3.jpg");
QPixmap dice4("/home/nishad/pdd_workspace/oct-16/build/new/4.jpg");
QPixmap dice5("/home/nishad/pdd_workspace/oct-16/build/new/5.jpg");
#endif

#ifdef PCGUI
QPixmap blue("/home/nishad/pdd_workspace/oct-16/build/new/blue.jpg");
QPixmap green("/home/nishad/pdd_workspace/oct-16/build/new/green.jpg");
QPixmap yellow("/home/nishad/pdd_workspace/oct-16/build/new/yellow.jpg");
QPixmap orange("/home/nishad/pdd_workspace/oct-16/build/new/orange.jpg");
QPixmap red("/home/nishad/pdd_workspace/oct-16/build/new/red.jpg");
#endif

#ifdef PCGUI
QPixmap C_blue("/home/nishad/pdd_workspace/oct-16/build/new/C_blue.jpg");
QPixmap C_green("/home/nishad/pdd_workspace/oct-16/build/new/C_green.jpg");
QPixmap C_yellow("/home/nishad/pdd_workspace/oct-16/build/new/C_yellow.jpg");
QPixmap C_orange("/home/nishad/pdd_workspace/oct-16/build/new/C_orange.jpg");
QPixmap C_red("/home/nishad/pdd_workspace/oct-16/build/new/C_red.jpg");
#endif
...
QPixmap tick("/opt/new/yellow_tick.jpg");
    ...
    for(int i=0;i<5;i++){
        ...
        case 0:
              if(owts.owts_array[*(recv_index + i)][location]==0)
                  owts.label[*(recv_index + i)][location]->setStyleSheet("QLabel { background-color : rgb(224, 224, 224); color : rgb(224, 224, 224); }");
              else
                  owts.label[*(recv_index + i)][location]->setStyleSheet("QLabel { background-color : rgb(153, 255, 255); color : rgb(153, 255, 255); }");
        ...
        case 1:
            if(owts.owts_array[*(recv_index + i)][location]==0)
               owts.label[*(recv_index + i)][location]->setStyleSheet("QLabel { background-color : rgb(224, 224, 224); color : rgb(224, 224, 224); }");
                ...
                owts.label[*(recv_index + i)][location]->setStyleSheet("QLabel { background-color : rgb(204, 255, 153); color : rgb(204, 255, 153); }");
          break;
        case 2:
            if(owts.owts_array[*(recv_index + i)][location]==0)
               owts.label[*(recv_index + i)][location]->setStyleSheet("QLabel { background-color : rgb(224, 224, 224); color : rgb(224, 224, 224); }");
            else
               owts.label[*(recv_index + i)][location]->setStyleSheet("QLabel { background-color : rgb(255, 255, 153); color : rgb(255, 255, 153); }");
          break;
        case 3:
            if(owts.owts_array[*(recv_index + i)][location]==0)
               owts.label[*(recv_index + i)][location]->setStyleSheet("QLabel { background-color : rgb(224, 224, 224); color : rgb(224, 224, 224); }");
            else
               owts.label[*(recv_index + i)][location]->setStyleSheet("QLabel { background-color : rgb(255, 178, 102); color : rgb(255, 178, 102); }");
           break;
        ...
        case 4:
            if(owts.owts_array[*(recv_index + i)][location]==0)
              ...
              owts.label[*(recv_index + i)][location]->setStyleSheet("QLabel { background-color : rgb(255, 51, 51); color : rgb(255, 51, 51); }");
          break;
        }
    ...
    for(int i=0;i<5;i++){
        ...
        case 0:
              if(owts.owts_array[*(recv_index + i)][location]==0)
                  owts.label[*(recv_index + i)][location]->setPixmap(dice1);
              else
                 owts.label[*(recv_index + i)][location]->setPixmap(dice1);
            break;
        case 1:
            if(owts.owts_array[*(recv_index + i)][location]==0)
               owts.label[*(recv_index + i)][location]->setPixmap(dice1);
                ...
                owts.label[*(recv_index + i)][location]->setPixmap(dice2);
          break;
        case 2:
            if(owts.owts_array[*(recv_index + i)][location]==0)
               owts.label[*(recv_index + i)][location]->setPixmap(dice1);
            else
               owts.label[*(recv_index + i)][location]->setPixmap(dice3);
          break;
        case 3:
            if(owts.owts_array[*(recv_index + i)][location]==0)
               owts.label[*(recv_index + i)][location]->setPixmap(dice1);
            else
               owts.label[*(recv_index + i)][location]->setPixmap(dice4);
           break;
        ...
        case 4:
            if(owts.owts_array[*(recv_index + i)][location]==0)
              ...
              owts.label[*(recv_index + i)][location]->setPixmap(dice5);
          break;
        }
        owts.label[*(recv_index + i)][location]->show();
    }
    ...
    for(int i=0;i<5;i++){
        ...
        case 0:
              if(owts.owts_array[*(recv_index + i)][location]==0)
                  owts.label[*(recv_index + i)][location]->setPixmap(blue);
              else
                 owts.label[*(recv_index + i)][location]->setPixmap(blue);
            break;
        case 1:
            if(owts.owts_array[*(recv_index + i)][location]==0)
               owts.label[*(recv_index + i)][location]->setPixmap(green);
            else
                owts.label[*(recv_index + i)][location]->setPixmap(green);
          break;
        case 2:
            if(owts.owts_array[*(recv_index + i)][location]==0)
               owts.label[*(recv_index + i)][location]->setPixmap(yellow);
            else
               owts.label[*(recv_index + i)][location]->setPixmap(yellow);
          break;
        case 3:
            if(owts.owts_array[*(recv_index + i)][location]==0)
               owts.label[*(recv_index + i)][location]->setPixmap(orange);
            else
               owts.label[*(recv_index + i)][location]->setPixmap(orange);
           break;
        ...
        case 4:
            if(owts.owts_array[*(recv_index + i)][location]==0)
               owts.label[*(recv_index + i)][location]->setPixmap(red);
            else
              owts.label[*(recv_index + i)][location]->setPixmap(red);
          break;
        }
    ...
    for(int i=0;i<5;i++){
        ...
        case 0:
              if(owts.owts_array[*(recv_index + i)][location]==0)
                  owts.label[*(recv_index + i)][location]->setPixmap(C_blue);
              else
                 owts.label[*(recv_index + i)][location]->setPixmap(C_blue);
            break;
        case 1:
            if(owts.owts_array[*(recv_index + i)][location]==0)
               owts.label[*(recv_index + i)][location]->setPixmap(C_green);
            else
                owts.label[*(recv_index + i)][location]->setPixmap(C_green);
          break;
        case 2:
            if(owts.owts_array[*(recv_index + i)][location]==0)
               owts.label[*(recv_index + i)][location]->setPixmap(C_yellow);
            else
               owts.label[*(recv_index + i)][location]->setPixmap(C_yellow);
          break;
        case 3:
            if(owts.owts_array[*(recv_index + i)][location]==0)
               owts.label[*(recv_index + i)][location]->setPixmap(C_orange);
            else
               owts.label[*(recv_index + i)][location]->setPixmap(C_orange);
           break;
        ...
        case 4:
            if(owts.owts_array[*(recv_index + i)][location]==0)
               owts.label[*(recv_index + i)][location]->setPixmap(C_red);
            else
              owts.label[*(recv_index + i)][location]->setPixmap(C_red);
          break;
        }
    ...
    for(int i=0;i<5;i++){
        ...
        case 0://blue
              if(owts.owts_array[*(recv_index + i)][location]==0)
                  owts.label[*(recv_index + i)][location]->setStyleSheet("color: qlineargradient(spread:pad, x1:0 y1:0, x2:0 y2:50, stop:0 rgba(153, 255, 180, 255), stop:1 rgba(100, 100, 100, 255));"
                                                   "background-color: qlineargradient(spread:pad, x1:0 y1:0, x2:0 y2:1, stop:0 rgba(153, 255, 255, 255), stop:1 rgba(100, 100, 100, 255));");
              else
                  owts.label[*(recv_index + i)][location]->setStyleSheet("color: qlineargradient(spread:pad, x1:0 y1:0, x2:0 y2:50, stop:0 rgba(153, 255, 180, 255), stop:1 rgba(100, 100, 100, 255));"
                                                   "background-color: qlineargradient(spread:pad, x1:0 y1:0, x2:0 y2:1, stop:0 rgba(153, 255, 255, 255), stop:1 rgba(100, 100, 100, 255));");
            break;
        case 1://green
            if(owts.owts_array[*(recv_index + i)][location]==0)
                owts.label[*(recv_index + i)][location]->setStyleSheet("color: qlineargradient(spread:pad, x1:0 y1:0, x2:0 y2:50, stop:0 rgba(51, 255, 51, 255), stop:1 rgba(100, 100, 100, 255));"
                                                 "background-color: qlineargradient(spread:pad, x1:0 y1:0, x2:0 y2:1, stop:0 rgba(204, 255, 153, 255), stop:1 rgba(100, 100, 100, 255));");
            else
                owts.label[*(recv_index + i)][location]->setStyleSheet("color: qlineargradient(spread:pad, x1:0 y1:0, x2:0 y2:50, stop:0 rgba(51, 255, 51, 255), stop:1 rgba(100, 100, 100, 255));"
                                                 "background-color: qlineargradient(spread:pad, x1:0 y1:0, x2:0 y2:1, stop:0 rgba(204, 255, 153, 255), stop:1 rgba(100, 100, 100, 255));");
          break;
        case 2://yellow
            if(owts.owts_array[*(recv_index + i)][location]==0)
                owts.label[*(recv_index + i)][location]->setStyleSheet("color: qlineargradient(spread:pad, x1:0 y1:0, x2:0 y2:50, stop:0 rgba(255, 255, 10, 255), stop:1 rgba(100, 100, 100, 255));"
                                                 "background-color: qlineargradient(spread:pad, x1:0 y1:0, x2:0 y2:1, stop:0 rgba(255, 255, 10, 255), stop:1 rgba(100, 100, 100, 255));");
            else
                owts.label[*(recv_index + i)][location]->setStyleSheet("color: qlineargradient(spread:pad, x1:0 y1:0, x2:0 y2:50, stop:0 rgba(255, 255, 10, 255), stop:1 rgba(100, 100, 100, 255));"
                                                 "background-color: qlineargradient(spread:pad, x1:0 y1:0, x2:0 y2:1, stop:0 rgba(255, 255, 10, 255), stop:1 rgba(100, 100, 100, 255));");
            break;
        case 3://orange
            if(owts.owts_array[*(recv_index + i)][location]==0)
                owts.label[*(recv_index + i)][location]->setStyleSheet("color: qlineargradient(spread:pad, x1:0 y1:0, x2:0 y2:50, stop:0 rgba(255, 128, 0, 255), stop:1 rgba(100, 100, 100, 255));"
                                                 "background-color: qlineargradient(spread:pad, x1:0 y1:0, x2:0 y2:2, stop:0 rgba(255, 128, 0, 255), stop:1 rgba(100, 100, 100, 255));");
            else
                owts.label[*(recv_index + i)][location]->setStyleSheet("color: qlineargradient(spread:pad, x1:0 y1:0, x2:0 y2:50, stop:0 rgba(255, 128, 0, 255), stop:1 rgba(100, 100, 100, 255));"
                                                 "background-color: qlineargradient(spread:pad, x1:0 y1:0, x2:0 y2:2, stop:0 rgba(255, 128, 0, 255), stop:1 rgba(100, 100, 100, 255));");
            break;
        ...
        case 4://red
            if(owts.owts_array[*(recv_index + i)][location]==0)
                owts.label[*(recv_index + i)][location]->setStyleSheet("color: qlineargradient(spread:pad, x1:0 y1:0, x2:0 y2:50, stop:0 rgba(255, 10, 10, 150), stop:1 rgba(100, 100, 100, 255));"
                                                 "background-color: qlineargradient(spread:pad, x1:0 y1:0, x2:0 y2:2, stop:0 rgba(255, 10, 10, 255), stop:1 rgba(100, 100, 100, 255));");
            else
                owts.label[*(recv_index + i)][location]->setStyleSheet("color: qlineargradient(spread:pad, x1:0 y1:0, x2:0 y2:50, stop:0 rgba(255, 0, 0, 150), stop:1 rgba(100, 100, 100, 255));"
                                                 "background-color: qlineargradient(spread:pad, x1:0 y1:0, x2:0 y2:2, stop:0 rgba(255, 10, 10, 255), stop:1 rgba(100, 100, 100, 255));");
            break;
        }
        owts.label[*(recv_index + i)][location]->show();
