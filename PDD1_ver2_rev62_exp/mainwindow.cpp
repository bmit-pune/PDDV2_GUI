...
float arr_float_sorted[NO_OF_FFT_VALS];
float arr_float_noise[NO_OF_FFT_VALS/2];
...

{
    ...
    customPlot_avg->yAxis->setLabel("Avg (mV)");
    ...
    customPlot_max->yAxis->setLabel("Max (mV)");
...
void MainWindow::batteryLevelChanged(int nValue){
    ...
    if(30 >= nValue)
    {
        ...
        user_hint("Battery Low: Save data...");
    }
    else if(80 >= nValue)
    {
