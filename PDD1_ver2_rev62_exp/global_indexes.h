...
#define FILE_CANNOT_COPY_TO_TEMP        1002
#define FILE_NOT_PRESENT_ON_PENDRIVE    1003
#define FILE_UPGRADE_SUCCESS            1004
...
extern float arr_float_sorted[NO_OF_FFT_VALS];
extern float arr_float_noise[NO_OF_FFT_VALS/2 ];
