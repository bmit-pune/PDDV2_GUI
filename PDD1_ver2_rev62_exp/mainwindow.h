...
signed int gap_in_bars;

unsigned long severity_arr_loc0[OWTS_steps];
unsigned long severity_arr_loc1[OWTS_steps];
unsigned long severity_arr_loc2[OWTS_steps];
unsigned long severity_arr_loc3[OWTS_steps];
unsigned long severity_arr_loc4[OWTS_steps];
unsigned long severity_arr_loc5[OWTS_steps];
unsigned long severity_arr_loc6[OWTS_steps];
unsigned long severity_arr_loc7[OWTS_steps];
unsigned long severity_arr_loc8[OWTS_steps];
unsigned long severity_arr_loc9[OWTS_steps];
