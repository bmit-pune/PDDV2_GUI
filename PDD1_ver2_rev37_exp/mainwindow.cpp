...
qDebug("LOC_MON %d",rand()%10);
    ...
    if(loc.iteration< (dialog.Set_Time*12))
    {
        ...
        for(int i=0;i<NO_OF_RAW_VALS && dialog.Set_Threshold>=arr_float_mV[i];i++)
        {
            ...
            if(arr_float_mV[i]>10 && arr_float_mV[i]<30) //for owts
                owts.owts_array[0][loc.location]++;
            else if(arr_float_mV[i]>30 && arr_float_mV[i]<50)
                owts.owts_array[1][loc.location]++;
            else if(arr_float_mV[i]>50 && arr_float_mV[i]<100)
                owts.owts_array[2][loc.location]++;
            else if(arr_float_mV[i]>100 && arr_float_mV[i]<150)
                owts.owts_array[3][loc.location]++;
            else if(arr_float_mV[i]>150 && arr_float_mV[i]<200)
...
#define LABELHEIGHT 20
    ...
    QPixmap circle("/home/nishad/pdd_workspace/oct-16/build/shapes/red.png");
    QPixmap square("/home/nishad/pdd_workspace/oct-16/build/shapes/square.png");
    QPixmap cross(":./shapes/cross.png");
    QPixmap triangle(":./shapes/triangle.png");

    //temp
    QPixmap red("/home/nishad/pdd_workspace/oct-16/build/shapes/red.png");
    QPixmap green("/home/nishad/pdd_workspace/oct-16/build/shapes/green.png");
    QPixmap blue("/home/nishad/pdd_workspace/oct-16/build/shapes/blue.jpg");
    QPixmap yellow("/home/nishad/pdd_workspace/oct-16/build/shapes/yellow.jpg");
        ...
        for(int j=0;j<MAX_LOC_MON_LOCATIONS;j++)
        {
           // owts.owts_array[i][j]=(unsigned long)1 + ( std::rand() % ( 240 - 1 + 1 ) );
            ...
            if(owts.owts_array[i][j]>0 && owts.owts_array[i][j]<80) {
              ...
              owts.label[i][j]->setPixmap(green);
              owts.label[i][j]->setGeometry(ui->customPlot->xAxis->coordToPixel(j)+owts.adjx,ui->customPlot->yAxis->coordToPixel(i)+owts.adjy,LABELWIDTH,LABELHEIGHT);
              owts.label[i][j]->show();
            }
              ...
              owts.label[i][j]->setPixmap(yellow);
              owts.label[i][j]->setGeometry(ui->customPlot->xAxis->coordToPixel(j)+owts.adjx,ui->customPlot->yAxis->coordToPixel(i)+owts.adjy,LABELWIDTH,LABELHEIGHT);
              owts.label[i][j]->show();
            }

            else if(owts.owts_array[i][j]>240) {
              owts.label[i][j]->setPixmap(red);
              owts.label[i][j]->setGeometry(ui->customPlot->xAxis->coordToPixel(j)+owts.adjx,ui->customPlot->yAxis->coordToPixel(i)+owts.adjy,LABELWIDTH,LABELHEIGHT);
              owts.label[i][j]->show();
            }
